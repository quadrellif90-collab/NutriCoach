...
def init_db():
    ...
    if not row or row[0] != '2.20.15':
        ...
        """)
        cur.execute("INSERT OR REPLACE INTO _app_version (version) VALUES ('2.20.15')")
    else:
        cur.execute("INSERT OR IGNORE INTO _app_version (version) VALUES ('2.20.15')")
    con.commit()
    seed_food_catalog()
    return con
