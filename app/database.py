...
def init_db():
    ...
    if not row or row[0] != '2.20.9':
        ...
        """)
        cur.execute("INSERT OR REPLACE INTO _app_version (version) VALUES ('2.20.9')")
    else:
        cur.execute("INSERT OR IGNORE INTO _app_version (version) VALUES ('2.20.9')")
    con.commit()
    seed_food_catalog()
    return con
